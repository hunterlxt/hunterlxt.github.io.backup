...
![1544359214933](虚拟化virtualization.assets/1544359214933.png)
...
![1544360428875](虚拟化virtualization.assets/1544360428875.png)

![1544360441028](虚拟化virtualization.assets/1544360441028.png)
...
![1544430405868](虚拟化virtualization.assets/1544430405868.png)

![1544431373912](虚拟化virtualization.assets/1544431373912.png)
...
![1544432050745](虚拟化virtualization.assets/1544432050745.png)
...
![1544602258924](虚拟化virtualization.assets/1544602258924.png)
...
![1544607056105](虚拟化virtualization.assets/1544607056105.png)
...
![1544628427491](虚拟化virtualization.assets/1544628427491.png)
...
![1544680104576](虚拟化virtualization.assets/1544680104576.png)
...
![1544681422017](虚拟化virtualization.assets/1544681422017.png)
...
![1544692342630](虚拟化virtualization.assets/1544692342630.png)
...
![1544709781578](虚拟化virtualization.assets/1544709781578.png)
...
![1544755511040](虚拟化virtualization.assets/1544755511040.png)
...
![1544775381133](虚拟化virtualization.assets/1544775381133.png)
...
![1544797649896](虚拟化virtualization.assets/1544797649896.png)
...
![1544929184122](虚拟化virtualization.assets/1544929184122.png)
...
![1544933478861](虚拟化virtualization.assets/1544933478861.png)
...
![1545379921486](虚拟化virtualization.assets/1545379921486.png)
...
![1545725533985](虚拟化virtualization.assets/1545725533985.png)
...
![1545726227578](虚拟化virtualization.assets/1545726227578.png)
...
![1545726748617](虚拟化virtualization.assets/1545726748617.png)
...
![1545728470676](虚拟化virtualization.assets/1545728470676.png)
...
![1545752745934](虚拟化virtualization.assets/1545752745934.png)

这样就会遇到一个 **segmentation fault** (关于内存的错误)

![1545752943405](虚拟化virtualization.assets/1545752943405.png)
...
![1545819820843](虚拟化virtualization.assets/1545819820843.png)

![1545819843581](虚拟化virtualization.assets/1545819843581.png)
...
![1545821288294](虚拟化virtualization.assets/1545821288294.png)
...
![1545822312393](虚拟化virtualization.assets/1545822312393.png)
...
![1545828191928](虚拟化virtualization.assets/1545828191928.png)

比如这个例子中，就有3个 segment ，每个都能在物理地址中独立存储。且各自有自己的base and bounds pair。

![1545828486095](虚拟化virtualization.assets/1545828486095.png)
...
![1545829763988](虚拟化virtualization.assets/1545829763988.png)
...
![1545830190862](虚拟化virtualization.assets/1545830190862.png)

## 16.4 Support for Sharing

![1545830327923](虚拟化virtualization.assets/1545830327923.png)
...
![1545831485503](虚拟化virtualization.assets/1545831485503.png)
...
![1545982094820](虚拟化virtualization.assets/1545982094820.png)

free list 大概长这样：

![1545982109939](虚拟化virtualization.assets/1545982109939.png)
...
![1545982919015](虚拟化virtualization.assets/1545982919015.png)
...
![1545985298391](虚拟化virtualization.assets/1545985298391.png)

现在有一个 chunk 的mem被申请了，比如100字节，分配器首先找到一个特别大的 空闲chunk（只有一个），然后切割出够用的那部分。这些做好后，如上图17.4所示。

![无标题](虚拟化virtualization.assets/无标题-1545996893910.png)
...
![1546241846110](虚拟化virtualization.assets/1546241846110.png)
...
![1546245097465](虚拟化virtualization.assets/1546245097465.png)

![1546245108506](虚拟化virtualization.assets/1546245108506.png)
...
![1546245717225](虚拟化virtualization.assets/1546245717225.png)

当翻译时，通过查询前2位确定是7号物理页表（**physical page number** or **PPN**），如下图：

![1546246976946](虚拟化virtualization.assets/1546246976946.png)

## 18.2 Where are page table stored?

因为 page table 过于巨大，我们不能把当前运行的程序的对应页表放在MMU里。所以**暂时**只能放在内存中！！！

![1546247683665](虚拟化virtualization.assets/1546247683665.png)
...
![1546248771388](虚拟化virtualization.assets/1546248771388.png)
...
![1546324659497](虚拟化virtualization.assets/1546324659497.png)
...
![1546347553901](虚拟化virtualization.assets/1546347553901.png)
...
![1546410966914](虚拟化virtualization.assets/1546410966914.png)
...
![1546413897279](虚拟化virtualization.assets/1546413897279.png)
...
![1546414079888](虚拟化virtualization.assets/1546414079888.png)
...
![1546429592871](虚拟化virtualization.assets/1546429592871.png)

在例子中，有3个segment，因此3对 base/bounds pairs，每次 miss 找对应seg的page table，大概流程如下把：

![1546430600498](虚拟化virtualization.assets/1546430600498.png)
...
![1546432132359](虚拟化virtualization.assets/1546432132359.png)
...
![1546437128178](虚拟化virtualization.assets/1546437128178.png)
...
![1546437395218](虚拟化virtualization.assets/1546437395218.png)
...
![1546437535133](虚拟化virtualization.assets/1546437535133.png)
...
![1546438233283](虚拟化virtualization.assets/1546438233283.png)
...
![1546438322464](虚拟化virtualization.assets/1546438322464.png)
...
![1546484576557](虚拟化virtualization.assets/1546484576557.png)
...
![1546493015494](虚拟化virtualization.assets/1546493015494.png)

![1546493635754](虚拟化virtualization.assets/1546493635754.png)
...
![1546502948288](虚拟化virtualization.assets/1546502948288.png)
